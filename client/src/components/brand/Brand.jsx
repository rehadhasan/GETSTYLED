        ...
        <div className="bg-bg-white">
            <div className="container mx-auto px-4 py-10">
                <Fade direction="up" duration={800} triggerOnce>
                    <h2 className="text-black text-opacity-90 lg:text-3xl md:text-2xl text-lg font-bold text-start">Explore Brands</h2>
                </Fade>
                <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-4 py-4">
                    {BrandList.slice(0,visibleCategories).map((brand) => (
