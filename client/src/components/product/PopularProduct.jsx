...
const PopularProduct = () => {
    ...
    const totalProducts = PopularProductList.length;

    // আরও ৮টি প্রোডাক্ট লোড করা
    const handleLoadMore = () => {
        setVisibleProducts((prev) => prev + 8);
    };

    // প্রথম ৮টি প্রোডাক্টে ফিরে যাওয়া এবং স্ক্রল টপে নেওয়া
    const handleShowLess = () => {
        setVisibleProducts(8);
        window.scrollTo({ top: document.getElementById("popular-products").offsetTop - 50, behavior: "smooth" });
    };

    return (
        <div className="bg-white" id="popular-products">
            <div className="container mx-auto px-4 py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 py-4">
                    {PopularProductList.slice(0, visibleProducts).map((product, index) => (
